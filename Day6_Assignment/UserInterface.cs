...
namespace Day6
{
    ...
    class ScreenDescription : UserInterface
    {
        ...
        public void showEnrollments()
        {
            ...
            Console.WriteLine("Student Name\t Course Name\tDate of Enrollment\n");
        ...
        public void showAllStudentsScreen()
        {
            ...
            foreach (Student student in en.listOfStudent())
        ...
        public void showStudentDetailsById()
        {
            ...
            for (int i = 0; i < en.StudentArr.Count(); i++)
            {
        ...
        public void showAllCoursesScreen()
        {
            ...
            Console.WriteLine("\nID  Course Name\tDuration\tLevel/Type\tSeats Available\tFee");
        ...
        public void introduceNewCourseScreen()
        {
            ...
            if (choice == "Degree")
            {
                ...
                if (dtype=="Bachelors" && placement=="yes")
                {

                    en.introduce(new DegreeCourse(CourseId, CourseName, CourseDuration, CourseFees, seats, Enum.Parse<DegreeCourse.level>("Bachelors"), true,true));
                }
                else if(dtype=="Masters"&& placement=="yes")
                {

                    en.introduce(new DegreeCourse(CourseId, CourseName, CourseDuration, CourseFees, seats, Enum.Parse<DegreeCourse.level>("Masters"), true,true));
                }
                else if(dtype=="Masters"&& placement=="no")
                {

                    en.introduce(new DegreeCourse(CourseId, CourseName, CourseDuration, CourseFees, seats, Enum.Parse<DegreeCourse.level>("Masters"), true,false));
                }
                else if(dtype=="Masters"&& placement=="no")
                {
            ...
            else if (choice == "Diploma")
            {
                ...
                en.introduce(new DiplomaCourse(CourseId, CourseName, CourseDuration, seats, CourseFees, Enum.Parse<DiplomaCourse.type>(type)));
            }
        ...
        public void showEnrollmentScreen()
        {
            ...
            for (int i = 0; i < en.CourseArr.Count(); i++)
            {
                if (courseid == Int32.Parse(en.CourseArr[i].CourseId))
                {
                    ...
                    else
                    {
                        ...
                        en.enroll(student, course, date1);
                        course.seatsavaialble = course.seatsavaialble-1;
        ...
        public void showFirstScreen()
        {
            ...
            en.introduce(new DegreeCourse("11", "CS", "3 Months", 3000, 10, Enum.Parse<DegreeCourse.level>("Bachelors"), true,true));
